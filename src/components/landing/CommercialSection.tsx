    ...
    <div className="container mx-auto px-4 max-w-5xl relative z-10">
      ...
      >
        ...
        <p className="text-white/80 text-lg leading-relaxed max-w-3xl mx-auto">
          Vous gérez un espace accueillant des chiens ? Crotte&Go propose un service professionnel 
          de ramassage de déjections canines pour garantir la propreté, l'hygiène et le confort 
          de vos espaces extérieurs — pour vos clients, résidents et visiteurs.
        </p>
      </motion.div>
