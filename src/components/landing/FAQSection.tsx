...
{ q: "Dois-je signer un contrat ?", a: "Non ! Aucun contrat ni engagement. Vous pouvez commencer, mettre en pause ou annuler votre service à tout moment en nous contactant par email à contact@crotteetgo.be ou par téléphone." },
...
{ q: "Dans quelles régions intervenez-vous ?", a: "Pour le moment, Crotte&Go® intervient exclusivement à Bruxelles et dans le Brabant Wallon. Nous prévoyons d'étendre nos zones de service prochainement, suivez nous sur nos réseaux sociaux pour être tenu informé!" },
];
