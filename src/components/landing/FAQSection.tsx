...
{ q: "Dois-je signer un contrat ?", a: "Non ! Aucun contrat ni engagement. Vous pouvez commencer, mettre en pause ou annuler votre service à tout moment en nous contactant par email à hello@crotteandgo.be, ou par téléphone." },
